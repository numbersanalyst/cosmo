...
const textures = {
  ...
  earthLand: textureLoader.load('/public/8k_earth_land_ocean_ice.png'),
  earthTopo: textureLoader.load('/public/8k_earth_topography.png'),
  stars: textureLoader.load('/public/8k_stars_milky_way.jpg'),
};
